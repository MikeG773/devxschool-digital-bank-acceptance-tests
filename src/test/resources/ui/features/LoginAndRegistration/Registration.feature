...
Feature: Digital Bank Registration Page
  ...
  #Registration Page Positive Test Scenario Automation
  @Test
  ...
  Scenario Outline: Negative Test Cases. As a Digital Bank Admin I want to make sure users can not register without providing all valid data
    ...
    Examples:
      ...
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random |        |           |            |          |        |            |         |            |             |           |                | email          | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random |           |            |          |        |            |         |            |             |           |                | password       | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 |            |          |        |            |         |            |             |           |                | address        | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 | 12 Main st |          |        |            |         |            |             |           |                | locality       | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 | 12 Main st | city     |        |            |         |            |             |           |                | region         | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 | 12 Main st | city     | CA     |            |         |            |             |           |                | postalCode     | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 | 12 Main st | city     | CA     | 99921      |         |            |             |           |                | country        | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 | 12 Main st | city     | CA     | 99921      | US      |            |             |           |                | homePhone      | Please fill out this field.                   |
      | Mr.   | Jack      | Test     | M      | 12/12/1990 | random | random | Tester123 | 12 Main st | city     | CA     | 99921      | US      | 2146591008 |             |           |                | termsCheckMark | Please check this box if you want to proceed. |

    #confirmpassword need to validate this as well?